...
(let* ((bg "#1f231a")
      ...
      (on-primary "#1f221b")
      (on-primary-container "#fcfff9")
      (on-secondary "#1f221b")
      (on-secondary-container "#000000")
      (on-surface "#f2f3f2")
      (on-surface-variant "#b2b6af")
      (on-tertiary "#1f221b")
      (on-tertiary-container "#e4efea")
      (outline-color "#656e5e")
      (outline-variant "#66725a")
      (primary "#aad97d")
      (primary-container "#518321")
      (secondary "#b8e4d7")
      (secondary-container "#37b38e")
      (shadow "#1f231a")
      (surface "#1f231a")
      (surface-container "#333b2b")
      (surface-container-high "#2e3626")
      (surface-container-highest "#38432d")
      (surface-container-low "#191d16")
      (surface-container-lowest "#0f110d")
      (surface-variant "#293021")
      (tertiary "#89cdac")
      (tertiary-container "#2a7953")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#89cdac")
      (on-success "#1f221b")
      (success-container "#2a7953")
      (on-success-container "#e4efea")
      ;; Map fixed colors to regular colors
      (primary-fixed "#aad97d")
      (primary-fixed-dim "#518321")
      (secondary-fixed "#b8e4d7")
      (secondary-fixed-dim "#37b38e")
      (tertiary-fixed "#89cdac")
      (tertiary-fixed-dim "#2a7953")
      (on-primary-fixed "#1f221b")
      (on-primary-fixed-variant "#fcfff9")
      (on-secondary-fixed "#1f221b")
      (on-secondary-fixed-variant "#000000")
      (on-tertiary-fixed "#1f221b")
      (on-tertiary-fixed-variant "#e4efea")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f2f3f2")
      (inverse-primary "#aad97d")
      (inverse-surface "#1f231a")
