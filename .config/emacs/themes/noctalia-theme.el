...
(let* ((bg "#231a1b")
      ...
      (on-primary "#221b1c")
      (on-primary-container "#ebe0e2")
      (on-secondary "#221b1c")
      (on-secondary-container "#ebe4e0")
      (on-surface "#f3f2f2")
      (on-surface-variant "#b6afb0")
      (on-tertiary "#221b1c")
      (on-tertiary-container "#ebe9e0")
      (outline-color "#736366")
      (outline-variant "#796164")
      (primary "#c18b91")
      (primary-container "#6a2f36")
      (secondary "#b29480")
      (secondary-container "#543c2b")
      (shadow "#231a1b")
      (surface "#231a1b")
      (surface-container "#3b2b2d")
      (surface-container-high "#362628")
      (surface-container-highest "#432d30")
      (surface-container-low "#1d1617")
      (surface-container-lowest "#110d0e")
      (surface-variant "#302123")
      (tertiary "#b2ac80")
      (tertiary-container "#54502b")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#b2ac80")
      (on-success "#221b1c")
      (success-container "#54502b")
      (on-success-container "#ebe9e0")
      ;; Map fixed colors to regular colors
      (primary-fixed "#c18b91")
      (primary-fixed-dim "#6a2f36")
      (secondary-fixed "#b29480")
      (secondary-fixed-dim "#543c2b")
      (tertiary-fixed "#b2ac80")
      (tertiary-fixed-dim "#54502b")
      (on-primary-fixed "#221b1c")
      (on-primary-fixed-variant "#ebe0e2")
      (on-secondary-fixed "#221b1c")
      (on-secondary-fixed-variant "#ebe4e0")
      (on-tertiary-fixed "#221b1c")
      (on-tertiary-fixed-variant "#ebe9e0")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f3f2f2")
      (inverse-primary "#c18b91")
